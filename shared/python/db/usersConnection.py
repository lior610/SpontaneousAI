"""
PostgreSQL connection module for Users database.
Contains users, trips, preferences, and user-related data.
"""
import psycopg2
...
def get_db_config():
    """Get database configuration from POSTGRES_* environment variables."""
    return {
